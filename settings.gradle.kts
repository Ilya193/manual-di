...
include(":features:feature-messages:api")
include(":features:feature-messages:impl")
include(":features:feature-detail-message:api")
include(":features:feature-detail-message:impl")
